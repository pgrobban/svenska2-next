  ...
  const lessonChunks = [
    <div className="lesson-chunk">
      ...
      <p>
        ...
        courses and how to use this textbook in general. The way you interact
        with the site will be different depending on whether you're using a
        smart phone, tablet or computer. However, all of the lesson contents and
    ...
    <div className="lesson-chunk">
      ...
      <p>
        ...
        Swedish but only read it, you may skip this course. However, you will
        see that pronouncing words correctly will help you internalizing your
      ...
      <p>
        You can take the lessons in any order. However, I recommend that you
        take them in the order they appear in as the grammar points and
        vocabulary will be based upon previous lessons.
      </p>
    </div>,
    <div className="lesson-chunk">
      ...
      <h5>Lesson goals</h5>
      <p>
        Each lesson starts with a short list of 2-3 goals that you achieve in
        that lesson. Most of these goals correspond to a grammar point and/or an
        exercise.
      </p>

      <h5>Text</h5>
      <p>
        You will be presented with a short text or conversation. You can listen
        to the texts by clicking on the sound icon
    ...
    <div className="lesson-chunk">
      ...
      <p>
        ...
        list will also have voice recordings so you can practice them
      ...
      <p>
        ...
        exceptions, you will sometimes see a text within square brackets []
        which indicates how the word should be spelled if it were according to
        the rules.
      </p>
      <p>
      ...
      <p>
        Words marked with "See GP" have a grammar point associated with them in
        a separate section after the word list.
        <br />
    ...
    <div className="lesson-chunk">
      ...
      <p>
        ...
        practice the grammar is simply doing the exercises (see next section)
        over and over until it sticks. After all, practice makes perfect.
      </p>

      <h5>Culture notes</h5>
      <p>
        Finally, some lessons will have notes about Swedish culture in the last
        section. This information can be useful if you live in Sweden and want
        to blend in with the locals (which you totally should).
      </p>
    </div>,
    <div className="lesson-chunk">
    ...
    <div className="lesson-chunk">
      ...
      <p>
        ...
        you use the site. This will enable us to save your progress in the
        cloud, no matter where you are in the world.
        <br />
        ...
        encourage you to write your own texts that you can submit to us and a
        real person will grade them!
      </p>
    </div>,
    <div className="lesson-chunk">
      <h5>Useful apps</h5>
      <p>
        ...
        <img
          ...
          style={{ width: 75 }}
        />
        This is the logo for the Swedish Academy (Svenska Akademien). The
        Swedish Academy publishes a glossary regularly called SAOL (Svenska
        Akademiens ordlista), and they now have a free app with the same name
        that you can download (iOS/Android) for these exercises. I will tell you
        how to use the app in some of the lessons.
      </p>
      <p>
        The SAOL app is actually intended for native Swedes, and thus it is
        entirely in Swedish. However, because it has all the forms of words,
        such as conjugations and declensions, I find it very useful for learners
        as well. I suggest that you use it instead of relying on automatic
    ...
    <div className="lesson-chunk">
      ...
      <br />
      <p>
        That's pretty much all I have to say about using the site. I would love
        to hear your feedback or if you have any questions about the lessons or
